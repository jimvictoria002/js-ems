...
<div class="w-full flex flex-col items-start mb-40" id="evaluation-form">
    ...
    <?php else:
        ...
        <div class="question-container flex flex-col shadow-lg p-5 rounded-md border mt-10 w-[98%] mx-auto my-2">
            ...
            <input type="text" name="title" value="<?= $title ?>" onchange="updateForm(this)" data-form-id="<?= $f_id ?>" placeholder="Enter form title"
                class="text-xl md:text-2xl font-semibold p-1 border-b border-b-gray-600 w-full outline-none " autocomplete="off">
            <input type="text" name="description" value="<?= $description ?>" onchange="updateForm(this)" data-form-id="<?= $f_id ?>" placeholder="Description"

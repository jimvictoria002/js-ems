        ...
        <div class="flex flex-col md:flex-row w-full gap-7 border p-8">
            ...
            <div class="w-full flex flex-col justify-between">
                ...
                <div class="flex self-end gap-3 md:flex-row flex-col md:mt-2 mt-5" id="btn-container">
                    <button type="button" class="px-8 py-2  self-start md:text-base text-sm  cursor-pointer transition-default  font-semibold rounded-xl hidden <?= (($_SESSION['access'] == 'admin' || $_SESSION['access'] == 'staff') ? '!hidden' : '') ?>" id="feedback-btn"></button>

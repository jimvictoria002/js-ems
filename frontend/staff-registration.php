    ...
    <div class="w-full px-3 fixed inset-0 z-40 " id="create-staff-modal">
        <div class=" bg-white rounded-lg z-50 px-5 w-[20rem] md:w-[25rem] max-h-[90vh] overflow-auto py-5 pb-0 fixed top-[50%] left-[50%] flex flex-col gap-2" style="transform: translate(-50%, -50%);" id="invitation-form">
            ...
            <div class="flex justify-between items-start">
                <p class="text-xl md:text-2xl font-semibold mb-2 md:mb-3 text-green-950">Staff registration</p>
            ...
            <form action="../backend/create/create_staff.php" method="POST" class="flex flex-col gap-y-3" id="create-form">
                ...
                <div class="flex flex-col ">
                    ...
                    <p class="p-1 border  rounded-sm w-full">
                        <?= $email ?>
                    </p>
                </div>
                <div class="flex flex-col ">
                ...
                <button class=" px-6 py-1.5 md:py-1 self-end md:text-base text-sm bg-green-800 hover:bg-green-700 transition-default text-white font-semibold rounded-md mt-2 mr-2  mb-5" id="create-btn">Create</button>
            </form>

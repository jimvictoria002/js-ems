...
//             break;
//         case 'student':
//             $query = "SELECT std_id as response_id,firstname as firstname, middlename as middlename, lastname as lastname, email as email FROM sis.students LIMIT $limit";
//             break;
//         case 'parent':

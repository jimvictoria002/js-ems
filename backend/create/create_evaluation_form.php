...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    <div class="question-container flex flex-col shadow-lg p-5 rounded-md border mt-10 w-[98%] mx-auto my-2">
        ...
        <input type="text" name="title" value="<?= $title ?>" onchange="updateForm(this)" data-form-id="<?= $f_id ?>"
        ...
        <input type="text" name="description" value="<?= $description ?>" onchange="updateForm(this)"
            ...
            class="text-sm md:text-base my-3 p-1 border-b border-b-gray-600 w-[90%] outline-none " autocomplete="off">
                ...
                <div class="w-full">
                    <div class="w-full text-sm md:text-lg  flex flex-col">
                        ...
                        <input type="text" placeholder="Enter question"
                            ...
                            id="question-<?= $question['q_id'] ?>" name="question" data-question-id="<?= $question['q_id'] ?>"
                            value="<?= $question['question'] ?>" onchange="saveQuestionInput(this)">
                    </div>
    ...
    <button type="button" onclick="createNewQuestion(this)"
        class="px-6 self-center py-2  mb-10 text-sm md:text-base mr-10 bg-green-800 hover:bg-green-700 transition-default text-white font-semibold rounded-xl">Add
        new question
